...
# python series_grad_desc.py data_filename.txt Niteration initial_guess.txt optimized_value.txt 
...
for i in range(Niter):
    ...
    Losses[i]=Loss0
    dLdRs = Loss(s, Rs+dRs, Ls, Rp, Lp, Cp, Zmeas) - Loss0 #/ dRs
    dLdLs = Loss(s, Rs, Ls+dLs, Rp, Lp, Cp, Zmeas) - Loss0 #/ dLs
